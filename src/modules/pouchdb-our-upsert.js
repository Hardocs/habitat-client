// this is npmjs pouchdb-upsert cloned, with one crucial modification
// pouchdb-promise only compensates for no Promise present, but doesn't import properly by webpack

'use strict';

var PouchPromise = Promise // require('pouchdb-promise');
